...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-28 21:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8af52a8c-9ffe-4b86-9e07-0974a80169a3.git
$ cd 8af52a8c-9ffe-4b86-9e07-0974a80169a3
```
